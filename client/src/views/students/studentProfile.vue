        ...
        <div class="row">
          <div class="col-lg-3">
            <div class="profile-avatar">
              <div class="avatar-letter text-center">{{first_name[0]}} {{last_name[0]}}</div>
            </div>
          ...
          <div class="col-lg-9">
            <div class="profile-form">
              ...
              <h1 class="profile-heading">
                Personal Details
                <span>~ Fill in both details</span>
              </h1>
              <div class="profile-fields">
                <h3 class="profile-subheading">First name</h3>

                <base-input alternative class="mb-3" placeholder="First name" v-model.trim="fname"></base-input>
              </div>
              <div class="profile-fields">
                <h3 class="profile-subheading">Last name</h3>

                <base-input alternative class="mb-3" placeholder="Last name" v-model.trim="lname"></base-input>
              </div>
  ...
  methods: {
    getPremium: function() {
      return this.$router.replace({
        name: 'premiumMember',
        params: { token: this.$store.getters.userID }
      });
    },
